...
SELECT 
	um.nama_usaha, 
	piu.nama_lengkap AS nama_pemilik,
	ku.nama_kategori,
	su.nama_skala,
	kk.nama_kabupaten_kota,
	um.tahun_berdiri
FROM umkm um
JOIN pemilik_umkm piu ON um.id_pemilik = piu.id_pemilik
JOIN kategori_umkm ku ON um.id_kategori = ku.id_kategori
JOIN skala_umkm su ON um.id_skala = su.id_skala
...
SELECT 
	um.nama_usaha,
	piu.nama_produk,
	piu.deskripsi_produk,
	piu.harga
FROM produk_umkm piu
JOIN umkm um ON piu.id_umkm = um.id_umkm
